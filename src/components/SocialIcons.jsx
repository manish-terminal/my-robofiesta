...
const IconWrapper = ({ children, href }) => (
  <a
    ...
    className="text-white/60 hover:text-[var(--neon)] transition-colors duration-200"
  >
    {children}
  </a>
);
...
// Social media links
const SOCIAL_LINKS = {
  YOUTUBE: 'https://youtube.com/@robofiestarvitm',
  INSTAGRAM: 'https://www.instagram.com/robofiesta.rvitm/',
  GITHUB: 'https://youtube.com/@robofiestarvitm',
